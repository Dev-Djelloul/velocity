export const translations = {
  fr: {
    ...
    dashboard: {
      ...
      planStatusPro: 'Plan Pro activé — tu as tout ce qu\'il faut sous la main, il ne manque plus qu\'un plan à lancer.',
      planStatusFree: 'Plan Gratuit actif — largement de quoi démarrer, fonce sur ton prochain plan.',
      createPlan: 'Créer un nouveau plan',
      current: 'Actuel',
      openSpace: 'Ouvrir',
  ...
  en: {
    ...
    dashboard: {
      ...
      planStatusPro: 'Pro plan active — you\'ve got everything you need, all that\'s left is a plan to launch.',
      planStatusFree: 'Free plan active — plenty to get started with, go build your next plan.',
      createPlan: 'Create a new plan',
      current: 'Current',
      openSpace: 'Open',
      planCount: (n) => `${n} plan${n > 1 ? 's' : ''}`,
