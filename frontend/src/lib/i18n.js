export const translations = {
  fr: {
    ...
    copilot: {
      ...
      empty: 'Posez une question ou demandez une modification, le copilote se charge de tout le reste !',
  ...
  en: {
    ...
    copilot: {
      ...
      empty: 'Ask a question or request a change — the copilot takes care of the rest!',
