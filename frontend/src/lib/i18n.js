export const translations = {
  fr: {
        ...
        groups: [
          ...
          },
          {
            ...
            items: [
              ...
              'Tableau de bord : bandeau défilant de conseils générés par IA (renouvelés toutes les 15 min), calendrier du mois mettant en évidence tous les sprints actifs (tous plans confondus) avec détail cliquable par jour, prochaines échéances enrichies (date exacte, urgence en couleur, accès direct au plan), carte "Reprendre" vers le dernier plan touché, fil d\'activité récente et résumé hebdomadaire cross-plans généré par Nova (Pro)',
    ...
    dashboard: {
      ...
      greetingCombined: (name, planLabel) => `Bonjour ${name}, voici un aperçu du jour. Tu es sur le plan ${planLabel}, alors n'hésite pas à travailler et à créer la start-up de tes rêves !`,
      greetingCombinedGeneric: (planLabel) => `Bonjour, voici un aperçu du jour. Tu es sur le plan ${planLabel}, alors n'hésite pas à travailler et à créer la start-up de tes rêves !`,
      planLabelPro: 'Pro',
  ...
  en: {
        ...
        groups: [
          ...
          },
          {
            ...
            items: [
              ...
              'Dashboard: scrolling AI-generated tip ticker (refreshed every 15 min), monthly calendar highlighting every active sprint across all plans with a clickable day detail, richer upcoming deadlines (exact date, color-coded urgency, direct link to the plan), "Resume" card to the last-touched plan, recent-activity feed and a cross-plan weekly summary generated by Nova (Pro)',
    ...
    dashboard: {
      ...
      greetingCombined: (name, planLabel) => `Hi ${name}, here's a look at your day. You're on the ${planLabel} plan, so don't hold back — go build the startup of your dreams!`,
      greetingCombinedGeneric: (planLabel) => `Hi there, here's a look at your day. You're on the ${planLabel} plan, so don't hold back — go build the startup of your dreams!`,
      planLabelPro: 'Pro',
      planLabelFree: 'Free',
