export const translations = {
  fr: {
    ...
    outputs: {
      ...
      prepStartHint: 'Date à laquelle le Sprint 1 démarre — change-la si le travail a réellement commencé avant ou après aujourd\'hui. La roadmap, le Gantt, le burndown et le calendrier se recalculent à partir d\'elle. Le lancement visé, lui, est cette date + la durée totale des sprints ci-dessous. Le slider "Délai" de la carte Budget & Délai ne fait que déplacer cette date cible affichée — il ne change PAS la durée réelle des sprints ci-dessous (ça exigerait de les reconstruire, avec perte du travail déjà fait). Pour que la roadmap corresponde vraiment au nouveau délai, il faut la reconstruire — il n\'existe pas de méthode qui étende une roadmap déjà planifiée sans repartir de zéro.',
