  ...
  return (
    ...
    <div className="plan-viewer-layout">
      ...
      <div className="plan-grid">
        ...
        <div id="section-roadmap" className={`plan-section-anchor ${mobileSectionId === 'section-roadmap' ? 'is-active' : ''}`}><RoadmapCard roadmap={plan.roadmap} lang={lang} planStartDate={plan.planStartDate || plan.generatedAt} onPlanStartDateChange={updatePlanStartDate} onRoadmapChange={updateRoadmap} targetTimelineWeeks={timelineWeeks} onRegenerateRoadmap={() => setConfirmRegenerateRoadmap(true)} /></div>
        <div id="section-backlog" className={`plan-section-anchor ${mobileSectionId === 'section-backlog' ? 'is-active' : ''}`}><BacklogCard roadmap={plan.roadmap} lang={lang} onRoadmapChange={updateRoadmapFromBacklog} jira={plan.jira} plan={plan} userId={userId} isPro={isPro} onRequestUpgrade={onRequestUpgrade} onNotionStoriesSynced={updateNotion} onJiraExported={updateJira} teamMembers={team.teamId ? team.members : []} /></div>
