export const content = {
  ...
  en: {
    ...
    channelAssetsGeneric: { postBrief: 'Content tailored to the channel, focused on user benefit.', emailSubject: 'Discover [product]', landingTagline: 'Simplify [goal] with [product]' },
    kpiFocus: {
      retain: {
